...
if (isset($_POST['save']) && Admin::getInstance()->permissions('products', CC_PERM_EDIT)) {
	...
	//BSMITHER USING OWN PRODUCT ID ON NEW ITEM if (isset($record['product_code_auto'])) {
if (isset($record['product_code_auto']) && !empty($record['product_code_auto'])) {
...
//MY attempt at Notes Tab
$GLOBALS['main']->addTabControl('My Product Notes', 'product_notes');
//
