   ...
   <div>
      <div id="order_summary" class="tab_content" style="width: 660px;">
         ...
         <div id="order_overview">
		  ...
		  <!-- MY OVERVIEW LINK WITH MR. MRS. ETC. -->
	  	     {$OVERVIEW_SUMMARY.title_d} {$OVERVIEW_SUMMARY.name_d}<br>
			 <!-- END MY OVERVIEW LINK -->
		  ...
		  <!-- MY OVERVIEW LINK  -->
	  	    {$OVERVIEW_SUMMARY.title} {$OVERVIEW_SUMMARY.name}<br>
			<!-- END MY OVERVIEW LINK -->
...
<div>
 ...
 <!--END MY LINKS-->
		...
		<!--Bsmither Add Current Email Address-->
		<fieldset class="other" style="width: 650px;"><legend><em>Current</em> {$LANG.account.contact_details} for <a href="{$CUSTOMER_CURRENT.link}" target="_blank">Customer ID: {$OVERVIEW_SUMMARY.customer_id}</a></legend>
		<div><label>{$LANG.common.email}</label><span><a href="mailto:{$CUSTOMER_CURRENT.email}">{$CUSTOMER_CURRENT.email}</a></span></div>
	{if !empty($CUSTOMER_CURRENT.phone)}	
...
{if !empty($CUSTOMER_CURRENT.mobile)}
		...
		<!--end Bsmither Add Current Email Address-->
		...
		<!-- MY BOX SPACING -->
            <fieldset class="other">
	  	<fieldset class="other"style="width: 650px;"><legend>{$LANG.orders.title_shipping}</legend>
		<!-- END MY BOX SPACING -->
