         ...
         <tr>
            <td valign="top" nowrap="nowrap" width="25%">
               ...
               <ul>
                  ...
                  {foreachelse}
<!-- MY ADDED LINKS -->
<li> <a href="?_g=statistics&bots=false#stats_online">Users Online</a></li>
<li><a href="?_g=products&node=export">Export Catalogue</a></li>
<li><a href="?_g=maintenance">Maintenance</a></li>
<hr>
 <!-- END MY LINKS -->
            ...
            <td valign="top" nowrap="nowrap" width="25%">
<!-- MY ADDED LINKS -->
<li><a href="http://www.cubecartforums.org/index.php?s=2d837eb93b08f1a2a452ae37205d44dc&act=Login&CODE=00" target="_blank">3rd Party Forum</a></li>
<li><a href="https://forums.cubecart.com/login/" target="_blank">Forum Login</a></li>
 <!-- END MY LINKS -->
               {if isset($NEWS)}
