...
<div id="rebuild" class="tab_content">
  ...
  <fieldset><legend>{$LANG.maintain.title_rebuild_catalogue} ({$LANG.settings.title_seo_urls} HIDDEN IN MAINTENANCE.INDEX.PHP)</legend>
 ...
 <!-- <fieldset><legend>{$LANG.settings.title_seo_urls} HIDDEN IN MAINTENANCE.INDEX.PHP</legend>
HIDDEN BECAUSE SO CATASTROPHIC IF ACCIDENTALLY CHOSEN - IN 6.0.2 <fieldset><legend>{$LANG.settings.title_seo_urls}</legend>
