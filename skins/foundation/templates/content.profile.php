...
<div>
   ...
   <form action="{$VAL_SELF}" method="post" id="profile_form">
      ...
      <div class="row">
         <div class="small-12 large-8 columns"><label for="passnew" class="show-for-medium-up">{$LANG.user.password_new}</label><input type="password" autocomplete="off" name="passnew" id="passnew" placeholder="{$LANG.user.password_new} (at least 6 characters)"></div>
      </div>
      <div class="row">
