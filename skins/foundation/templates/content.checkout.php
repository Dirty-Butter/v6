...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data" class="autosubmit" id="checkout_form">
   ...
   {/if}
   <div class="clearfix">
      <!--<div class="show-for-medium-up">--><div><a href="{$STORE_URL}/index.php?_a=basket&empty-basket=true" class="button alert left"><i class="fa fa-trash-o"></i> {$LANG.basket.basket_empty}</a></div>
      <!--<div class="show-for-medium-up">--><div><button type="submit" name="update" class="button secondary left" value="{$LANG.basket.basket_update}"><i class="fa fa-refresh"></i> {$LANG.basket.basket_update}</button></div>
      ...
      <div class="show-for-medium-up"><button type="submit" name="proceed" id="checkout_proceed" class="button right">{$CHECKOUT_BUTTON} <i class="fa fa-chevron-right"></i></button></div>
<div class="show-for-small-only"><button type="submit" name="proceed" id="checkout_proceed" class="button left">{$CHECKOUT_BUTTON} <i class="fa fa-chevron-right"></i></button></div>
      {/if}
   </div>
</form>
{if $CHECKOUTS}
