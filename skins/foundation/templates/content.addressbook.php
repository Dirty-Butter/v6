...
<form action="{$VAL_SELF}" method="post" id="addressbook_form" enctype="multipart/form-data">
   ...
   <div class="row">
      <div class="small-12 large-8 columns"><label for="addr_company_name">{$LANG.address.company_name}</label><input type="text" name="company_name" id="addr_company_name" value="{$DATA.company_name}" placeholder="{$LANG.address.company_name} (or leave blank)"></div>
   </div>
   <address>
      <div class="row">
      ...
      <div class="row">
         <div class="small-12 large-8 columns"><label for="addr_line2">{$LANG.address.line2}</label><input type="text" name="line2" id="addr_line2" value="{$DATA.line2}" placeholder="{$LANG.address.line2} (if needed)"></div>
      </div>
      <div class="row">
      ...
      <div class="row">
         <div class="small-12 large-8 columns"><label for="addr_postcode">{$LANG.address.postcode}</label><input type="text" name="postcode" id="addr_postcode" value="{$DATA.postcode}" required placeholder="{$LANG.address.postcode} (e.g. 35178, AB 593) {$LANG.form.required}"></div>
      </div>
      </div>
   </address>
   <div class="row">
