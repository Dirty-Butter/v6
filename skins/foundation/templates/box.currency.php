...
<div class="right text-center show-for-medium-up" id="box-currency"> 
 {if count($CURRENCIES)>1}
   <a href="#" data-dropdown="currency-switch" class="button white small">{$CURRENT_CURRENCY.symbol_left|escape:'htmlall'} {$CURRENT_CURRENCY.code} {$CURRENT_CURRENCY.symbol_right|escape:'htmlall'}<i class="fa fa-chevron-down" title="Select Currency"></i></a>
