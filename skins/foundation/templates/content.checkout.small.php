...
<div class="show-for-small-only">
   ...
   <div class="panel" id="basket_item_{$hash}">
      ...
      <div class="row">
         ...
         <div class="small-4 columns">
          <a href="#" class="quan subtract" rel="{$hash}"> <font color= "#BD0000"> <i class="fa fa-minus-circle"></i></font></a>
 ...
 <a href="#" class="quan add" rel="{$hash}"> <font color= "#BD0000"><i class="fa fa-plus-circle"></i></font></a>
         </div>
         <div class="small-3 columns">
            {$LANG.basket.total}
         </div>
