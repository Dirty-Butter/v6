...
<div class="row">
   <div class="large-6 columns">
      <form action="{$VAL_SELF}" id="login_form" method="post">
         <p class="show-for-small-only"><span class="redbold">{$LANG.account.want_to_signup} <a href="{$STORE_URL}/register.html">{$LANG.account.register_here}</a></span></p>
   ...
   <div class="large-6 columns show-for-medium-up">
      ...
      <p><span class="redbold">{$LANG.account.register_welcome}</span></p>
